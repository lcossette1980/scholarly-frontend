      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-charcoal font-playfair mb-6">
            Everything You Need for <span className="text-chestnut">Academic Research</span>
          </h1>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="card card-hover">
              ...
              <h3 className="text-2xl font-bold text-charcoal font-playfair mb-4">
                Bibliography Generator
              </h3>
              <p className="text-charcoal/70 font-lato mb-6 leading-relaxed">
        ...
        <div className="mb-20 py-16 bg-gradient-to-br from-red-50 via-white to-green-50 -mx-6 px-6">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-charcoal font-playfair text-center mb-12">
              The Traditional Way vs. <span className="text-chestnut">ScholarlyAI</span>
            </h2>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm">
                      <p className="text-charcoal/80 font-medium">Reading each paper (90 min/paper × 10 papers)</p>
                      <p className="text-charcoal/50 text-xs">~15 hours</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Clock className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal/80 font-medium">Writing bibliography entries</p>
                      <p className="text-charcoal/50 text-xs">~6 hours</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Clock className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal/80 font-medium">Identifying research topics & outlining</p>
                      <p className="text-charcoal/50 text-xs">~4 hours</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Clock className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal/80 font-medium">Writing complete paper draft</p>
                      <p className="text-charcoal/50 text-xs">~15 hours</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl border-2 border-green-500 p-6 shadow-xl relative">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm">
                      <p className="text-charcoal font-medium">Upload 10 PDFs to Bibliography Generator</p>
                      <p className="text-charcoal/50 text-xs">~2 minutes</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal font-medium">AI generates complete bibliography</p>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal font-medium">Generate topics & select outline</p>
                      <p className="text-charcoal/50 text-xs">~3 minutes</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal font-medium">AI writes complete paper draft</p>
                      <p className="text-charcoal/50 text-xs">~5 minutes</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div className="text-sm">
                      <p className="text-charcoal font-medium">Review, edit & refine</p>
                      <p className="text-charcoal/50 text-xs">~2 hours</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="card">
              ...
              <h3 className="text-lg font-bold text-charcoal font-playfair mb-2">Research Focus Customization</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-bold text-charcoal font-playfair mb-2">GPT-4 Powered</h3>
              <p className="text-charcoal/70 text-sm font-lato">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-bold text-charcoal font-playfair mb-2">Methodology Analysis</h3>
              <p className="text-charcoal/70 text-sm font-lato">
            ...
            <div className="card">
              ...
              <h3 className="text-lg font-bold text-charcoal font-playfair mb-2">Private & Secure</h3>
              <p className="text-charcoal/70 text-sm font-lato">
        ...
        {/* CTA Section */}
        <div className="card bg-gradient-chestnut text-white text-center max-w-4xl mx-auto">
