        ...
        <div className="card space-y-8">
          ...
          <section>
            ...
            <div className="flex items-start space-x-3">
              <FileText className="w-5 h-5 text-chestnut mt-1" />
              <div>
                <p className="text-charcoal/80 font-lato">
          ...
          <section>
            ...
            <ul className="space-y-3 text-charcoal/80 font-lato">
              <li className="flex items-start space-x-3">
                <span className="w-2 h-2 bg-chestnut rounded-full mt-2 flex-shrink-0"></span>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <CreditCard className="w-5 h-5 text-chestnut mt-1" />
                <div>
                  <h3 className="font-semibold text-charcoal font-lato">Payment Terms</h3>
                  <p className="text-charcoal/70 font-lato">
              ...
              <div className="flex items-start space-x-3">
                <Users className="w-5 h-5 text-chestnut mt-1" />
                <div>
                  <h3 className="font-semibold text-charcoal font-lato">Usage Limits</h3>
                  <p className="text-charcoal/70 font-lato">
          ...
          <section>
            ...
            <p className="text-charcoal/80 font-lato">
              ...
              <a href="mailto:legal@scholarlyaiapp.com" className="text-chestnut hover:text-chestnut/80">
