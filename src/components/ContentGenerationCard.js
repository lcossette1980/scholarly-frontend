...
const ContentGenerationCard = ({ entries }) => {
  ...
  return (
    <FadeIn direction="up">
      <div className="glass-card bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 p-6 mb-6 hover:shadow-lg transition-all duration-300">
